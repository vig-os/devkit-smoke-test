...
milestone: none
projects: none
synced: 2026-07-10T06:03:01.688Z
---
...
## [Comment #1](https://github.com/vig-os/devcontainer-smoke-test/pull/152#issuecomment-4927198912) by [@c-vigo](https://github.com/c-vigo)

_Posted on July 9, 2026 at 04:12 PM_

Closing as superseded. GitHub Actions updates are now owned by Renovate (`enabledManagers` includes `github-actions`), so this dependabot-authored group bump is redundant. Renovate will propose any outstanding action updates. Dependabot is being removed as part of the renovate migration.

---

## [Comment #2](https://github.com/vig-os/devcontainer-smoke-test/pull/152#issuecomment-4927199282) by [@dependabot[bot]](https://github.com/apps/dependabot)
...
### Commit 1: [b5b58a4](https://github.com/vig-os/devcontainer-smoke-test/commit/b5b58a4eed367244f66523e6e08e5065dcf4f99e) by [dependabot[bot]](https://github.com/apps/dependabot) on June 18, 2026 at 12:09 PM
ci(deps): bump the actions-minor-patch group across 1 directory with 2 updates, 6 files modified (.github/workflows/renovate-changelog.yml)
